...
void _wishListItemAttach(
  ...
  object.id = id;
  object.shop.attach(col, col.isar.collection<Shop>(), r'shop', id);
}
...
extension WishListItemQueryFilter
  ...
  QueryBuilder<WishListItem, WishListItem, QAfterFilterCondition> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension WishListItemQueryLinks
    on QueryBuilder<WishListItem, WishListItem, QFilterCondition> {
  QueryBuilder<WishListItem, WishListItem, QAfterFilterCondition> shop(
      FilterQuery<Shop> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'shop');
    });
  }

  QueryBuilder<WishListItem, WishListItem, QAfterFilterCondition> shopIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'shop', 0, true, 0, true);
    });
  }
}
